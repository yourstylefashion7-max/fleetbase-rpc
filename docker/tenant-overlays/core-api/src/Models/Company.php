...
class Company extends Model
{
    ...
    /**
     * Scope organizations that are allowed to authenticate and receive work.
     *
     * Legacy Fleetbase stores an active organization as NULL while newer
     * callers may persist the explicit "active" value.
     */
