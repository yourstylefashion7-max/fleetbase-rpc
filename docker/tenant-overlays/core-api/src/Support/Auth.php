...
class Auth extends Authentication
{
    ...
    /**
     * Retrieves the active company from server-managed session context.
     *
     * Client-provided company or company_uuid request values are intentionally
     * ignored. Call getCompanyFromRequest() only in an explicitly authorized flow.
     *
